package deteccionTecla;

/**
 * Created by Joseba on 14/09/2016.
 */
/*
...
public final class tecla extends Application {


    public void start(final Stage stage) {
        final Keyboard keyboard = new Keyboard(new Key(KeyCode.SPACE));
